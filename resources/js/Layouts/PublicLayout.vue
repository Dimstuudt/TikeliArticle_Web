...
<template>
  <div class="min-h-screen bg-gray-50 flex flex-col">
    <!-- Navbar -->
    <header class="bg-blue-600 text-white shadow px-6 py-3 flex justify-between items-center">
      <!-- Kiri: Logo + Menu -->
      ...
      <div class="flex items-center">
        <template v-if="user">
          ...
          <Dropdown align="right" width="48">
            <template #trigger>
              <button
                class="flex items-center px-3 py-1 rounded-md bg-blue-400 hover:bg-blue-500 transition text-sm font-medium focus:outline-none"
              >
                <img
        ...
        <template v-else>
          ...
          <Link
            href="/login"
            class="px-4 py-2 rounded-md bg-blue-400 hover:bg-blue-500 transition text-sm font-semibold"
          >
            Login / Register
          </Link>
        </template>
