...
// 🔹 Load script reCAPTCHA sekali aja
onMounted(() => {
  ...
  <GuestLayout>
    ...
    <form @submit.prevent="submit">
        ...
        <div
          ...
          :class="{
            ...
            'bg-blue-100 border border-blue-300':
              isPasswordLongEnough && isPasswordStrong && form.password !== form.password_confirmation,
      ...
      <div class="mt-6">
        ...
        <div class="w-full rounded-md border border-gray-300 bg-white px-4 py-3 shadow-sm flex items-center justify-center">
