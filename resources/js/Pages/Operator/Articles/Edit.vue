          ...
          <form class="space-y-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div class="space-y-6 lg:col-span-1">
                <h3 class="text-lg font-medium text-gray-800 border-b pb-2">Info Artikel</h3>
              ...
              <div class="space-y-6 lg:col-span-2">
                <h3 class="text-lg font-medium text-gray-800 border-b pb-2">Konten Artikel</h3>
            ...
            <div class="flex justify-end gap-4 pt-6 border-t">
              <button
                type="button"
                @click="saveAsDraft"
                class="bg-gray-500 hover:bg-gray-600 text-white px-5 py-2 rounded-md text-sm font-medium shadow-sm"
              >
                Simpan Draft
              </button>
